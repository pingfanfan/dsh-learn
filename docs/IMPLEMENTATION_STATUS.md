...
- [x] 官方 Discussions 新问题分流卡已按 #614 当前分页基线重新核对 #37、#38、#40 及公开评论，正文日期和 GitHub 渠道稿已更新并获得新的 GitHub 文件回执；仍未把 Windows/Firefox、`koffi` 或归档会话报告写成官方修复，知乎未发布。
