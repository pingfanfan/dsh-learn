...
- [x] 官方 Discussions 监控已修复分页盲区：最新连接器复核到 6 页、550 条公开讨论，编号从 #12 到 #564；#560–#564 的缓存展示、图片输入建议、真实协作反馈、Windows 中文路径和第三方网关兼容信号已分别分层处理，不把列表增长、用户报告、社区回复、社区 fork 或第三方测试代码包装成新功能、官方修复或官方发行版。
