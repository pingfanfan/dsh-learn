...
维护基线（2026-08-14）。此前官方 Discussions 已复核到 7 页、700 条公开讨论，编号从 `#12` 到 `#720`。当前来源已复核到第 12 页、观察到的最后编号为 `#1159`，这些新分页只用于确认上游仍在增长，不改写本卡对 #539–#549 的历史观察，也不把后续 `#550–#1159` 的其他报告混入本卡结论。
...
- 事实基线：DeepSeek Harness 官方 commit `47f943859bef60e4160492346772ded9b24f765a`。当前讨论列表已复核到第 12 页、观察至 #1159。
...
- [当前 Discussions 分页基线（维护复核至 #1159）](https://api.github.com/repos/deepseek-ai/deepseek-harness/discussions?per_page=100&page=12)
