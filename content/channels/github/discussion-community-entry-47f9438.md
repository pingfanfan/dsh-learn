...
> 事实基线：2026-08-14；DeepSeek Harness commit `47f943859bef60e4160492346772ded9b24f765a`；npm `@deepseek-ai/dsh@0.1.0-rc.6`。本次维护复核时，官方 Discussions 公开列表已经推进到第 12 页，观察到的最后编号为 `#1159`；本卡片仍只使用 `#12/#14` 作为历史入口依据，不把后续讨论写成官方解决方案。DSH 仍处于 Developer Preview，下面的入口和讨论内容可能随官方仓库变化。
...
先按“你希望社区给出什么结果”选板块，板块是为了让问题进入合适的讨论流，不代表维护者一定会给出修复：
...
- [官方 Discussions 当前分页快照（复核至 #1159，第 12 页）](https://api.github.com/repos/deepseek-ai/deepseek-harness/discussions?per_page=100&page=12)
