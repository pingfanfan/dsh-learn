...
本文的历史范围仍然是 #565–#591。此前维护复核时，官方 Discussions 列表已更新为 7 页、700 条公开讨论，编号从 `#12` 到 `#720`。当前来源已复核到第 12 页、观察到的最后编号为 `#1159`，这些后续编号只用来标记上游分页增长，不混入本卡的历史结论。

官方源码观察固定在 commit `47f943859bef60e4160492346772ded9b24f765a`，包版本基线为 `@deepseek-ai/dsh@0.1.0-rc.6`。

## 验证范围与来源

- 当前基线：DeepSeek Harness 官方 commit `47f943859bef60e4160492346772ded9b24f765a`。使用 `@deepseek-ai/dsh@0.1.0-rc.6`，Discussions 已复核到第 12 页、观察至 #1159。
...
- [当前分页基线](https://api.github.com/repos/deepseek-ai/deepseek-harness/discussions?per_page=100&page=12)
