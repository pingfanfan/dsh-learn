...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 推荐标题：DeepSeek Harness 还在快速变，旧教程最容易错在这两处 | 9 | 10 | 10 | 10 | 9 | 48 |
| DeepSeek Harness 新手先别急着抄命令：两条旧路线已经失效 | 9 | 9 | 9 | 9 | 8 | 44 |
| DSH 早期使用指南：先认版本，再装插件 | 8 | 9 | 9 | 9 | 9 | 44 |
| DeepSeek Harness 插件怎么装？当前版本只认这一条主路 | 9 | 9 | 9 | 9 | 8 | 44 |
| 重新核对 DSH 官方仓库：这些旧教程该停用了 | 8 | 9 | 8 | 9 | 9 | 43 |
| DSH 进入开发者预览期，中文用户先记住这张迁移卡 | 8 | 9 | 9 | 9 | 8 | 43 |
| 从 .dsh-plugin 到 profile bundle：DSH 插件机制变了什么 | 8 | 10 | 8 | 9 | 9 | 44 |
| DeepSeek Harness 版本变化太快？用这 4 步判断教程还能不能用 | 9 | 9 | 10 | 9 | 9 | 46 |

推荐理由：推荐标题把“快速变化”与读者最可能踩中的两类失效知识放在一起，既说明风险，又没有把尚未完成的本地运行验证包装成结论。
...
【口述方向｜你第一次看到 DSH 时，更想马上开始使用，还是先看懂它为什么这样设计，可以说说自己更在意哪一项，但不要补充未经实测的安装经历｜建议100至200字｜不新增未经核验的数字、引语和亲历故事｜发布前删除本行】
...
【口述方向｜可以谈谈你为什么不准备一开始就做大而全的 DSH 课程，是担心接口变化，还是更看重持续更新和实际问题，只表达自己的选择，不虚构用户反馈｜建议100至200字｜不新增未经核验的数字、引语和亲历故事｜发布前删除本行】
...
1. DSH 新手避坑：`.dsh-plugin` 和 SDK 脚手架为什么都不能再照抄
2. DeepSeek Harness 当前版本迁移卡：插件主路、SDK 边界与安全提醒
3. 别把 DSH 教程写死：一张跟着官方版本更新的中文事实卡
...
- 维护规则：上述任一来源 revision 变化时，资产应自动进入 `STALE`，复核后再恢复发布。
