...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 推荐标题：DSH 接第三方 OpenAI 兼容网关，为什么还会 400 | 9 | 10 | 10 | 10 | 10 | 49 |
| DSH 网关配置新手指南：OpenAI 兼容不等于参数完全相同 | 9 | 10 | 10 | 10 | 9 | 48 |
| DeepSeek Harness 接中转网关，先检查 role 和思考参数 | 8 | 10 | 10 | 10 | 9 | 47 |
...
1. OpenAI 兼容网关接入 DSH，为什么模型能添加却不能对话
2. DeepSeek Harness 网关排障：先查 role，再查思考参数
3. DSH 新手接中转接口，别把第三方 fork 当成官方插件
