...
- Discussions 当前 revision 复核事实卡：[content/canonical/dsh-discussions-revision-20260814.md](content/canonical/dsh-discussions-revision-20260814.md)；它通过分页读取公开列表，只记录社区信号，不把用户报告写成官方修复。
